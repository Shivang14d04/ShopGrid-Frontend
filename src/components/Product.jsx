      ...
      <div className="container px-4">
        ...
        <div className="row g-5">
          ...
          <div className="col-md-6">
            <div className="premium-card p-4 border text-center d-flex align-items-center justify-content-center image-zoom-container" style={{ minHeight: "400px", backgroundColor: "#ffffff" }}>
              <img
            ...
            <div className="d-flex flex-column justify-content-between h-100">
              ...
              <div>
                ...
                <div className="d-flex align-items-baseline gap-2 mb-4">
                  ...
                  <h2 className="fw-bold mb-0 text-primary">₹{product.price.toLocaleString("en-IN")}</h2>
                </div>
