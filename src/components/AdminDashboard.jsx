          ...
          <div className="col-md-3 col-sm-6">
            <div className="premium-card p-4 border shadow-sm h-100" style={{ backgroundColor: "var(--bg-card)" }}>
              <div className="d-flex justify-content-between align-items-center mb-3">
                ...
                <span className="p-2 bg-primary-subtle text-primary rounded-circle d-flex align-items-center justify-content-center" style={{ width: "40px", height: "40px" }}>
          ...
          <div className="col-md-3 col-sm-6">
            <div className="premium-card p-4 border shadow-sm h-100" style={{ backgroundColor: "var(--bg-card)" }}>
              <div className="d-flex justify-content-between align-items-center mb-3">
                ...
                <span className="p-2 bg-success-subtle text-success rounded-circle d-flex align-items-center justify-content-center" style={{ width: "40px", height: "40px" }}>
          ...
          <div className="col-md-3 col-sm-6">
            <div className="premium-card p-4 border shadow-sm h-100" style={{ backgroundColor: "var(--bg-card)" }}>
              <div className="d-flex justify-content-between align-items-center mb-3">
                ...
                <span className="p-2 bg-info-subtle text-info rounded-circle d-flex align-items-center justify-content-center" style={{ width: "40px", height: "40px" }}>
                  <FiLayers size={20} />
                </span>
              </div>
          ...
          <div className="col-md-3 col-sm-6">
            <div className="premium-card p-4 border shadow-sm h-100" style={{ backgroundColor: "var(--bg-card)" }}>
              <div className="d-flex justify-content-between align-items-center mb-3">
                ...
                <span className={`p-2 rounded-circle d-flex align-items-center justify-content-center ${lowStockProducts > 0 ? 'bg-danger-subtle text-danger' : 'bg-secondary-subtle text-muted'}`} style={{ width: "40px", height: "40px" }}>
